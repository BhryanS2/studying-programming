...
int main() {
  ...
  */
  ...
  int coluna[n], linha[n], diagonalprincipal = 0, diagonalSecundaria = 0;
  int somal = 0, somac = 0;
  ...
  //diagonal principal
  for (int i = 0; i < n; i++) diagonalprincipal = diagonalprincipal + m[i][i];

  //diagonal Secundária
  for (int i = 0; i < n; i++) diagonalSecundaria = diagonalSecundaria+ m[i][n - 1 - i];
